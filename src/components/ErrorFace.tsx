...
export default function ErrorFace() {
  return (
    <div style={{ width: "75%" }}>
      <svg style={{ margin: "0 auto" }} className="face" viewBox="0 0 320 380" width="320px" height="380px" aria-label="A 404 becomes a face, looks to the sides, and blinks. The 4s slide up, the 0 slides down, and then a mouth appears.">
